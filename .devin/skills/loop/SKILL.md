...
argument-hint: "[correctness|performance|turbo] [iterations]"
triggers:
  - user
---
...
2. Choose the skill per improvement type:
   ...
   - Clarity → **refactor**
3. Follow the Improvement Loop summary in the rules (AGENTS.md)
...
- Follow Hard Stops in the rules (AGENTS.md)
